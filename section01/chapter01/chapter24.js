// 1. 날짜를 생성하는 방법
let date1 = new Date();
let timeValue = date1.getTime(); // 밀리타임으로 출력

console.log(date1);
console.log(timeValue);

//2.사용자가 직접 날짜를 설정
let date2 = new Date(1995, 1, 1, 23, 59, 59);
let timeValue2 = date2.getTime();

console.log(timeValue2);
console.log(date2);

//3. 상대방에게 getTime 값을 주게 되면, 날짜로 복구가 가능할까
...
let milli = date4.getMilliseconds();
console.log(year);
console.log(month);
console.log(date);
console.log(hour);
